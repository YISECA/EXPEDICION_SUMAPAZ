...
@section('content') 
    ...
    <form action="logear" method="POST"> 
		...
		<fieldset class="form-group">
			<label class="freebirdFormviewerViewItemsItemItemTitle" for="formGroupExampleInput" style="color: #FBF8EF">Usuario</label>
			<input title="Se nesesita el codigo" required type="text" class="form-control" id="usuario" name="usuario" >
		</fieldset>

		<fieldset class="form-group">
			<label class="freebirdFormviewerViewItemsItemItemTitle" for="formGroupExampleInput" style="color: #FBF8EF">Contraseña</label>
